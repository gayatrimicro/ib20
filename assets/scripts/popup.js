...
else
{
	...
	$("#autocomplete").click();
	$(".LocFie input").css("border","2px solid rgb(44, 152, 247)");
	$(".LocFie label").css("color","rgb(44, 152, 247)");	
}
});
...
//    }
 ...
 $('.LodSlid').slick({
		...
		$("#LblAni").click(function(){
		$("#LblAni").addClass("anim-typewriter");
		// $("#LblAni").addClass("anim-typewriter2");
		setTimeout(function(){ $("#autocomplete2").focus(); }, 300);
		
	});

		$("#autocomplete2").focusin(function(){
    	$("#LblAni").addClass("anim-typewriter");
  });
		$("#autocomplete2").focusout(function(){
    	$("#LblAni").removeClass("anim-typewriter");
