...
<head>
    ...
    <link rel="stylesheet" id="main-css" href="../assets/styles/main.css?v=4.7.0" media="none" onload="if(media!='all')media='all'">
...
<body data-module="Load" style="opacity: 0;">
    ...
    <a class="c-play-button" href="https://locomotive.ca/en/play" data-load="play" ga-on="click" ga-event-category="ui.menu.section" ga-event-action="click" ga-event-label="play">
    ...
    <div data-load-container>
            ...
            <div class="o-container">
                ...
                <nav class="c-header_nav">
                    <ul class="c-header_nav_list">
                        ...
                        <li class="c-header_nav_item">
                            <a class="c-header_nav_link -active o-link -circleHover" href="https://locomotive.ca/en/about">
                                Agency 
                                <svg preserveAspectRatio="none" viewBox="0 0 338 172" class="o-link_circle">
                                    <path vector-effect="non-scaling-stroke" d="M169,3.5c91.1,0,165,36.9,165,82.5s-73.9,82.5-165,82.5S4,131.6,4,86C4,40.4,77.9,3.5,169,3.5"></path>
                                </svg>
        ...
        <div class="c-nav_wrapper">
            ...
            <div class="c-nav_layout o-layout">
                <div class="o-layout_item u-2/3@from-thousand">
                    <div class="c-nav_section c-nav_main">
                        <a class="c-nav_lang_mobile" href="https://locomotive.ca/fr/a-propos" data-load="false" ga-on="click" ga-event-category="ui.lang-switcher" ga-event-action="click" ga-event-label="FR">
                            FR
                        </a>
            ...
            <a class="c-nav_play u-none@from-thousand" href="https://locomotive.ca/en/play" data-load="play">
            ...
            <ul class="c-nav_socials c-social" ga-on="click" ga-event-category="ui.social.nav" ga-event-action="click" ga-event-label="">
                ...
                <li class="c-nav_socials_item c-social_item">
                    <a href="https://www.behance.net/" class="o-link -circleHover" target="_blank" rel="noopener noreferrer">
                ...
                <div class="c-heading-lines_title">
                    <div class="c-heading-lines_title_line">
                        <div class="o-container">
                            ...
                            <div class="c-heading-lines_words">
                                <span class="c-heading-lines_word o-h1 -noMargin">A Digital-first</span>
                            </div>
                            <div class="o-line -elastic">
                    ...
                    <div class="c-heading-lines_title_line -rail">
                        <div class="c-heading-lines_words" data-module="Rail" data-shuffle data-rail-speed="1">
                            <span class="c-heading-lines_word o-h1">Montreal<div class="c-heading-lines_icon"><svg role="img"><use xlink:href="../assets/images/sprite.svg#icon-montreal"></use></svg></div></span>
                    ...
                    <div class="c-heading-lines_title_line">
                        <div class="o-container">
                            ...
                            <div class="c-heading-lines_words">
                                <span class="c-header-lines_word o-h1 -noMargin">Agency</span>
                            </div>
                            <div class="o-line -elastic">
                        ...
                        <div class="o-layout_item u-1/2@from-small">
                            <div class="o-section -padding-top -margin-small">
                                <div class="u-2/3@from-big">
                                    <p class="js-animate u-anim -delay-1">With more than a decade of marketing experience, iBridge has become the reference for all that’s digital, web design and branding. We’re not just bragging, we’re good. Our promise: finding tomorrow’s creative solutions — today.</p>
                                </div>
                            </div>

                            <div class="o-line -text"></div>
                            <div class="o-section -margin-small">
                                <p class="o-h3 u-2/3@from-big || o-fade-up-rows || js-animate" data-module="FadeUpByRow" data-lines-class="o-fade-up-rows_line" data-viewport-offset="0.3">We are a forward-thinking team of designers and developers driven by passion — and fuelled by curiosity.</p>
                            </div>
                        </div>
                    </div>
                </div>
