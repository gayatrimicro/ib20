...
<div  style="position: relative;">
	...
	<div class="o-image_inner">
		...
		<div class="o-layout js-animate" style="padding: 15rem 10rem;">
			<div class="o-layout_item u-1/2@from-medium" style="padding: 0rem;">
				<img src="../../uploads/projects/Tija/icons1.png">
			</div>
			<div class="o-layout_item u-1/2@from-medium" style="padding: 2rem 5rem 5rem 5rem;">
			...
			<div class="o-layout_item u-1/3@from-medium" style="padding: 5rem 5rem;">
...
<div class="c-device -desktop o-container" style="padding: 13.33333rem 11.2rem;margin: 0px;position: relative;background-color: #ea5159;">
	<div class="c-device_inner u-anim -delay-3 js-animate">
		<img src="../../assets/images/laptop.png" alt="">
		<div class="c-device_media">
			<div class="o-vimeo-player" style="width: 93%;display: block;margin: 0 auto;border-radius: 5px;margin-top: 5px;padding-bottom: 0px;">
	...
	<div class="c-device_inner u-anim -delay-3 js-animate">
		...
		<div class="c-device_media">
			<div class="o-vimeo-player">
				...
				<video id="desk_vid" class="lazyload" autoplay loop>
				  <source class="lazyload" src="../../assets/videos/Harsha-Mob-Home.mp4"  type="video/mp4">
				</video>
			</div>
		</div>
	</div>
		...
		<div class="c-fancy-video c-project_intro_item js-animate has-video is-show" style="padding-bottom: 0% !important;margin-top: 0% !important;">
			<div>
				<div class="o-layout">
                    ...
                    <div class="o-layout_item u-1/3@from-medium" style="width: 25%;">
                    	<img src="../../uploads/projects/Harsha/box1.jpg">
                    </div>
                    <div class="o-layout_item u-1/3@from-medium" style="margin-top: 10rem;width: 25%;">
                    	<img src="../../uploads/projects/Harsha/box2.jpg">
                    </div>
                    <div class="o-layout_item u-1/3@from-medium" style="width: 25%;">
                    	<img src="../../uploads/projects/Harsha/box5.jpg">
                    </div>
                    <div class="o-layout_item u-1/3@from-medium" style="margin-top: 10rem;width: 25%;">
                    	<img src="../../uploads/projects/Harsha/box3.jpg">
                    </div>
                </div>
...
<figure class="o-image -parallax" style="background-color: #f0a82e;width: 80%;">
	<div class="o-image_inner ">
		...
		<img src="../../uploads/projects/Tija/logonew.png" style="position: absolute;width: 200px;height: 200px;z-index: 99999999;display: block;transform: translate(40px,52rem);right: 25%;">
		<div class="o-layout js-animate" style="padding: 15rem 5rem;">
				<div class="o-layout_item u-1/3@from-medium" style="padding: 5rem 4rem;">
...
<!-- <figure class="o-image -parallax">
	<div class="o-image_inner">
		<img src="../../uploads/projects/Tija/logo.png" style="position: absolute;width: 200px;height: 200px;z-index: 99999999;display: block;transform: translate(40px,-80px);right: 5%;">
		<img src="../../uploads/projects/Tija/spice.jpg" alt="" class="js-animate" data-speed="-6">
	</div>
</figure> -->
		...
		<div class="c-fancy-video c-project_intro_item js-animate has-video is-show" style="padding-bottom: 0% !important;margin-top: 0% !important;">
			<div>
				<video id="desk_vid1" class="lazyload" autoplay loop>
				  <source class="lazyload" src="../../assets/videos/Tija-Product.mp4"  type="video/mp4">
				</video>
			</div>
...
@media (min-width: 1400px){
		...
		<div class="o-section -padding-v-big packing" style="padding: 11.33333rem 0rem;background: linear-gradient(to bottom, #f9e6e1 70%, #fff 30%);width: 80%;height:150vh;position: relative;">
	<div class="o-cursor_wrapper u-relative -show-native o-container js-animate" data-module="CursorZone" data-repeat data-callback="trigger.CursorZone()" data-draggable="true">
		...
		<div class="o-cursor -white || js-cursor">
					...
					<div style="position: absolute;display: block;top: 67%;right: 0%;">
						<img src="../../uploads/projects/arrow.png" style="width: 100px;height: 100px" alt="" />	
					</div>
...
<div class="o-layout js-animate">
	...
	<div class="o-layout_item u-1/3@from-medium">
		<div class="" style="height:35rem;background:#f9e6e1;position: relative;">
			<div class=" u-anim -delay-5 js-animate">
				<div class=" u-anim -delay-5 js-animate">
				<div class=" u-anim -delay-3 js-animate" style="padding: 3rem;color: #000 !important;">
				<h3 style="margin-bottom: 0px;">Silky Pink</h3>
				<div class="o-line -text" style="margin-top: 25px;margin-bottom: 25px;"></div>
				<p>SECONDARY</p>

				<p style="position: absolute;bottom: 20%;">Hex #f9e6e1</p>
			</div>
...
<section>
	...
	<div class="o-layout js-animate" style="position: relative;">
		<div class="o-layout_item u-1/2@from-medium" style="width: 30%;height: 80rem;">
			<div  style="background:#101820; height: 100%;">
				<div class="u-anim -delay-3 js-animate" style="padding: 30rem 3rem;">
					<h4>Magestic Blue</h4>
				<div class="o-line -text" style="margin-top: 15px;margin-bottom: 15px;"></div>
					<p>hex #000f0</p>

					<img src="../../uploads/projects/Tija/3.png" style="padding: 6rem 2rem;">
				</div>
			</div>
		</div>
		<div class="o-layout_item u-1/2@from-medium" style="width: 70%;height: 80rem;">
			<div style="background-image: url(../../uploads/projects/Tija/bg-change.jpg); height: 100%;background-position: center;background-size: cover;">
				<div class="u-anim -delay-5 js-animate" style="padding: 30rem 25rem 16rem 6rem">
		...
		<h2 style="position: absolute;top: 23%;left: 20%;font-weight: 900;font-size: 5rem;">Tija Foods</h2>
	</div>
...
<section>
	<div class="o-container demo u-bg-white" style="padding-bottom: 5rem;padding-top: 5rem;position: relative;">
                    ...
                    <div class="o-layout " style="">
                        <div class="o-layout_item u-1/2@from-small">
                            ...
                            <div class="c-mobile-device" style="padding: 4rem;margin-top: 3rem;">
								<div class="c-mobile-device_inner u-anim -delay-3 js-animate" style="padding: 0px;">
									...
									<video id="mob_1" class="outline-mob-video" class="lazyload" autoplay loop>
									  <source class="lazyload" src="../../assets/videos/Mob-Tija.mp4"  type="video/mp4">
									</video>
								</div>
							</div>													
                        </div>
                        <div class="o-layout_item u-1/2@from-small" style="margin-top: 3rem;">
                            <div class="o-section -padding-top -margin-small">
                                <div class="u-2/3@from-big">
...
<!-- <style type="text/css">
	.small-slider .c-slider_slide-inner img {
		...
		<div class="o-section -padding-v-big small-slider" style="padding: 13.33333rem 0rem;background-color: #ddd">
	<div class="o-cursor_wrapper u-relative -show-native o-container js-animate" data-module="CursorZone" data-repeat data-callback="trigger.CursorZone()" data-draggable="true">
		<div class="o-cursor -alpha js-cursor -ahead -drag -points -h">
			<div class="o-cursor_background"></div>
		</div>
