...
/* Animation */
.anim-typewriter{
  animation: typewriter 300ms steps(100) 100ms 1 normal both;
}
...
.anim-typewriter2{
  animation: typewriter2 300ms steps(100) 100ms 1 normal both;
}
...
<rect x="8.607" y="31.826" width="5.912" height="17.617"/>
                ...
                <nav class="c-header_nav">
                    <ul class="c-header_nav_list">
                        <li class="c-header_nav_item">
                            <a class="c-header_nav_link o-link -circleHover" href="../en/projects.php">
                                Projects
            ...
            <div class="c-nav_layout o-layout">
                    ...
                    <div class="c-nav_section c-nav_main">
                        ...
                        <ul class="c-nav_list">
                            <li class="c-nav_list_item">
                                <a href="../en/projects.php" data-load="nav">
                                    Projects
                                </a>
                                ...
                                <a href="../en/team.html" data-load="nav">
                                    Team
                                </a>
                            </li>                                                        <li class="c-nav_list_item">
                                <a href="../en/careers.html" data-load="nav">
                                    Careers
                                </a>
                            </li>                            <li class="c-nav_list_item">
                                <a href="../en/contact.html" data-load="nav">
                                    Contact
                                </a>
                            </li>                        </ul>
                    </div>
                ...
                <div class="o-layout_item u-1/3@from-thousand u-none@to-thousand">
                    <div class="c-nav_section c-nav_secondary">
                        ...
                        <ul class="c-nav_list">
                            <li class="c-nav_list_item">
                                <a href="../en/play.html" data-load="play">
        ...
        <!-- data-module="Scroll" data-main-scroll -->
<div class="o-scroll"  id="remAt">
    <main class="o-page">
                    ...
                    <section class="form-comp">
                        <div class="r-card contact-form" style="margin: 70px 157px;background-color: #fff;color: #000;text-align: center;padding: 5rem 4rem;">
                            ...
                            <div style="margin-top: 50px;">
                                <div class="PosRel22">
        <p class="line-1 posa" id="LblAni">enter your company name</p>
        <input type="text" class="form-control formcnt" id="autocomplete2" onFocus="geolocate()" placeholder="">
    </div>
        ...
        <footer class="c-footer">
            ...
            <div class="c-footer_inner js-animate" >
                ...
                <div class="c-footer_lines c-heading-lines_title">
                    ...
                    <div class="c-footer_lines_line -normal c-heading-lines_title_line">
                        <a class="o-container c-footer_line_container" data-module="Footer" href="../en/team.html" draggable="false">
                            <div class="o-line -elastic">
                                <canvas class="o-line_canvas js-animate" data-callback="inview.Rope()" data-module="Rope" data-delay="0.1" data-color="white"></canvas>
                            </div>
                            <div class="c-heading-lines_words -block js-animate" data-module="CursorZone" data-repeat data-callback="trigger.CursorZone()">
                            ...
                            <div class="u-text-right@from-small">
                                <ul class="c-footer_nav_list">
                                    <li class="c-footer_nav_item">
                                        <a href="../en/careers.html" class="o-link -circleHover">
                                            Careers
                                            <svg preserveAspectRatio="none" viewBox="0 0 338 172" class="o-link_circle">
                                    ...
                                    <li class="c-footer_nav_item">
                                        <a href="../en/team.html" class="o-link -circleHover">
                                            Team
                                            <svg preserveAspectRatio="none" viewBox="0 0 338 172" class="o-link_circle">
                                                <path vector-effect="non-scaling-stroke" d="M169,3.5c91.1,0,165,36.9,165,82.5s-73.9,82.5-165,82.5S4,131.6,4,86C4,40.4,77.9,3.5,169,3.5"/>
                                            </svg>
                                    ...
                                    <li class="c-footer_nav_item">
                                        <a href="../en/contact.html" class="o-link -circleHover">
                                            Contact
                                            <svg preserveAspectRatio="none" viewBox="0 0 338 172" class="o-link_circle">
                                                <path vector-effect="non-scaling-stroke" d="M169,3.5c91.1,0,165,36.9,165,82.5s-73.9,82.5-165,82.5S4,131.6,4,86C4,40.4,77.9,3.5,169,3.5"/>
                                            </svg>
