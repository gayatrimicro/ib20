		...
		<div class="c-project">
			...
			<div class="c-project-header js-animate" data-module="ProjectHeader" data-callback="trigger.ProjectHeader()" data-repeat>
				<div class="c-project-header_block">
					...
					<div class="c-project-header_block-bottom">
						<div class="c-project-header_title -rail" data-module="Rail" data-shuffle data-rail-speed="1">
							<span class="c-project-header_word o-h1" style="font-family: Proxima-Nova-Thin-Regular;font-weight: 100;">Second Docs</span>
						</div>
					</div>
				</div>
				...
				<div class="c-project-header_block">
					<div class="o-container">
						<div class="o-line -elastic">
							<canvas class="o-line_canvas js-animate" data-auto="true" data-module="Rope" data-delay="0.3" data-color="#fff"></canvas>
						</div>
						<div class="o-header-block">
					...
					<div class="c-project-header_block-bottom -container">
						<div class="c-project-header_title">
							<span class="c-project-header_word o-h1">UI & Web App.</span>
						</div>
					</div>
				...
				<div class="o-container">
					<div class="c-project-header_cta-wrapper || js-animate" data-speed="-1" data-position="top">
						<div class="c-project-header_cta">
							<a href="http://second.coffeeoverchat.com/" target="_blank" class="o-circle-button -large">
								<div class="o-circle-button_bg" style="background-color: #0000f0;"></div>
			...
			<div class="o-container || c-project_intro">
				...
				<div class="c-project_awards || o-header-block || c-project_intro_item || js-animate">
					<div class="o-line -elastic || u-none@from-small">
						<canvas class="o-line_canvas js-animate" data-auto="true" data-module="Rope" data-delay="0.1" data-color="#fff"></canvas>
					</div>
				...
				<div class="o-line -noMargin || u-none@to2-small"></div>
					...
					<div class="o-header-block || c-project_intro_item -text -about js-animate">
						...
						<h2 class="o-header-block_title u-anim -parent -delay-2">About Second Docs</h2>
						<p class="u-anim -parent -delay-4">Second Docs focuses on the second opinion, helping patients with care management in making sure the road to recovery can be as easy on the patient and family as possible. It also offers an array of specialty care services from nationally-recognized physicians, leveraging state-of-the-art equipment and customized treatment plans to help patients feel their best.</p>
					</div>
					<div class="o-header-block || c-project_intro_item -text -work js-animate">
						<div class="o-line -noMargin || u-none@from-small"></div>

						<h2 class="o-header-block_title u-anim -parent -delay-3">What we did</h2>
						<p class="u-anim -parent -delay-5">At a point where they were growing their sales team to expand further into the enterprise market, their brand and marketing website was holding them back. They needed a complete brand identity for the Ice cream stabiliser Market, a holding page which helped gain initial traction and helped him build the brand recognition.</p>
					</div>

				<div class="c-fancy-video c-project_intro_item js-animate has-video" data-module="FancyVideo">
					<div class="c-fancy-video_bg" style="background-color:#EB2931"></div>
					<div id="myid">
						<video id="fir_vid" muted autoplay>
						  <source src="../../assets/videos/Second-Docs.mp4" type="video/mp4">
						</video>
					<!-- <p style="position: absolute;top: 50%;left: 50%;transform: translate(-50%, -50%);">Here is the demo text</p> -->
					<div  style="color:#fff;position: absolute;top: 0%; left: 0%;height:100%;width:100%;background-color: #00003354;">
					<span class="c-project-header_word o-h1 video-overtext">SECOND OPINION MATTERS</span>
					</div>
				</div>
...
<figure class="o-image -parallax mob-boz" style="position: relative;">
	...
	<div class="opp-size">
		<div class="c-project-header_title" style="margin-bottom: 50px;">
			<span class="c-project-header_word o-h2" style="font-weight: 900;">The Opportunity</span>
		</div>
		<div class="o-line -text"></div>
		<div class="o-section -margin-small" style="margin-top: 30px;">
            <p class="o-h4 u-no-margin js-animate u-anim -delay-1 is-show opp-content">
		...
		<div class="c-device_media">
			<div class="o-vimeo-player">
				...
				<video id="desk_vid" class="lazyload" muted="" loop>
				  <source class="lazyload" src="../../assets/videos/second-docs-preview.mp4"  type="video/mp4">
				</video>
			</div>
		</div>
	</div>
...
.button-switch .switch#switch-orange {
  background: #ff5d48;
}
...
<style type="text/css">
	.video-overtext{
		font-size: 5.2rem;position:absolute;bottom: -6%;
	}
	.opp-content{
		width: 65%;
	}
	.opp-size{
		color:#003;position: absolute;top: 70%;left: 70%;width:50%;transform: translate(-50%, -50%);
	}
	.mockup-video{
		padding: 13.33333rem 11.2rem;margin: 0px;
	}
	.left-success{
		position: absolute;top: 90%;left: 135%;transform: translate(-50%, -50%);width: 100%;
	}
	.right-info{
		position: absolute;top: 85%;left: 45%;transform: translate(-50%, -50%);width: 100%;
	}
	.instruction-click{
		color: #000;margin-top: 0rem;text-align: center;
	}
	.toggle-me-mob{
		position: absolute;top: 300%;left: 30%;transform: translate(-50%, 300%);
	}
	.slider-imgs{
		padding: 13.33333rem 0rem;background-color: #ddd
	}
	@media (max-width: 600px){
		.video-overtext{
			font-size: 1.6rem;position:absolute;bottom: -6%;
		...
		.opp-size{
			color:#003;position: absolute;top: 25%;left: 0%;width:100%;transform: none;padding: 0px 1rem;
		}
		.mockup-video{
			padding: 01rem;
		}
		.left-success{
			position: absolute;top: 115%;left: 94%;transform: translate(-50%, -50%);width: 100%;
		}
		.instruction-click{
			margin-top: 8rem;
		}
		...
		.slider-imgs{
			padding: 3rem;background-color: #ddd
		}
	}
</style>
...
<!-- <figure class="o-image -parallax">
	<div class="o-image_inner">
		<img src="../../uploads/projects/Second/admin.png" alt="" class="js-animate" data-speed="-6">
	</div>
</figure> -->
...
<div class="o-section -padding-v-huge" style="background-color: #ddd;">
	<figure class="o-container"  data-theme="light">
		<div class="c-fancy-video c-project_intro_item js-animate has-video is-show" style="padding-bottom: 5rem; !important;margin-top: 0% !important;">
			<div>
				<video id="desk_vid1" class="lazyload" muted="" loop poster="../../uploads/projects/Second/admin.png">
				</video>
				<div class="button-switch left-success">
						  <div class="toast__container">
							...
							<!-- <p class="toast__message">Click the cross to see it in action.</p> -->
							</div>
						...
						<div class="button-switch right-info">
							...
							<!-- <p class="toast__message">Click the cross to see the action.</p> -->
							</div>
							<div class="toast__close">
							<svg version="1.1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 15.642 15.642" xmlns:xlink="http://www.w3.org/1999/xlink" enable-background="new 0 0 15.642 15.642">
							<path fill-rule="evenodd" d="M8.882,7.821l6.541-6.541c0.293-0.293,0.293-0.768,0-1.061  c-0.293-0.293-0.768-0.293-1.061,0L7.821,6.76L1.28,0.22c-0.293-0.293-0.768-0.293-1.061,0c-0.293,0.293-0.293,0.768,0,1.061  l6.541,6.541L0.22,14.362c-0.293,0.293-0.293,0.768,0,1.061c0.147,0.146,0.338,0.22,0.53,0.22s0.384-0.073,0.53-0.22l6.541-6.541  l6.541,6.541c0.147,0.146,0.338,0.22,0.53,0.22c0.192,0,0.384-0.073,0.53-0.22c0.293-0.293,0.293-0.768,0-1.061L8.882,7.821z"></path>
		...
		<p class="o-h4 instruction-click" >Click the cross to see it in action.</p>
	</figure>
</div>
...
<section  style="padding: -10rem 5rem 7rem 5rem; background-color: #ddd">
		...
		<div class="c-fancy-video c-project_intro_item js-animate has-video is-show" style="padding-bottom: 0% !important;margin-top: 0% !important;">
			<div>
				<div class="o-layout">
                    ...
                    <div class="o-layout_item u-1/2@from-medium" style="position: relative;">

                    	<div style="position: absolute;top: 50%;left: 30%;transform: translate(-50%, -50%);width: 100%;">
						  <div class="toast__container">
							<div class="toast__cell">
							<div class="toast toast--green">
							<div class="toast__icon">
                    ...
                    <div class="o-layout_item u-1/2@from-medium" style="position: relative;">
                    	...
                    	<div style="position: absolute;top: 50%;left: 50%;transform: translate(-30%, -50%);width: 100%;">
						  <div class="toast__container">
							<div class="toast__cell">
...
document.querySelector('body').addEventListener('click', () => {
  clearInterval(animate);
				...
				<!-- <div class="o-section -padding-v-huge u-bg-white" style="background-color: #1c1c20">
	<figure class="o-container"  data-theme="light">
		<div class="c-fancy-video c-project_intro_item js-animate has-video is-show" style="padding-bottom: 0% !important;margin-top: 0% !important;">
			<div>
				<video id="desk_vid1" class="lazyload" autoplay loop>
				  <source class="lazyload" src="../../assets/videos/Second-docs-home.mp4"  type="video/mp4">
				</video>
	...
	<div class="o-layout_item u-1/2@from-medium">
		<div class="c-mobile-device" style="background:#E6E6E6;">
			<div class="c-mobile-device_inner u-anim -delay-3 js-animate">
				...
				<video id="mob_1" class="lazyload" muted="" loop>
				  <source class="lazyload" src="../../assets/videos/Second-Home-Mob.mp4"  type="video/mp4">
				</video>
			</div>
		</div>
	</div>
	<div class="o-layout_item u-1/2@from-medium">
		<div class="c-mobile-device" style="background:#0E0E0E;">
			<div class="c-mobile-device_inner u-anim -delay-5 js-animate">
				...
				<img src="../../uploads/projects/Second/mobile_screen_720x1280_harsha_02.jpg" alt="">
				<!-- <video id="mob_2" class="lazyload" autoplay loop>
				  <source class="lazyload" src="../../assets/videos/Harsha-Training-Mob.mp4"  type="video/mp4">
				</video> -->
			</div>
		</div>
	</div>
	...
	<div class="o-container demo u-bg-white" style="padding-bottom: 5rem;padding-top: 5rem;">
                    <div class="o-layout ">
                        <div class="o-layout_item u-1/2@from-small" style="position: relative;">
	                    	...
	                    	<div class="button-switch toggle-me-mob">
							  <input type="checkbox" id="switch-orange" class="switch" style="cursor: pointer;" />
							  <p class="o-h4" style="color: #000;margin-top: 8rem;text-align: center;">Toggle me</p>
							  
							</div>
                    	</div>
                        <div class="o-layout_item u-1/2@from-small toggle-content">
                            <div class="o-section -padding-top -margin-small">
                                <div class="u-2/3@from-big">
                                    <p class="js-animate u-anim -delay-1">Built with a modern front-end and leveraging a JavaScript framework for fast loading across all devices, the new Second Docs site features smart navigation that allows patients to connect with a provider and a patient coordinator who guides the patient through out the patients journey.</p>
                            ...
                            <div class="o-section -margin-small">
                                <p class="o-h4 u-no-margin u-2/3@from-small js-animate u-anim -delay-1 is-show">A user-friendly CMS built using Laravel framework allows for simple notifications from the physicians as well as shows complete patient journey to the patient coordinator.</p>
				...
				<div class="c-slider_wrapper || swiper-wrapper">
					<div class="c-slider_slide || swiper-slide">
						<div class="c-slider_slide-inner">
							<img src="../../uploads/projects/Second/img_galerie_1920x1080_harsha_01.jpg" alt="" />
						</div>
					</div>
					<div class="c-slider_slide || swiper-slide">
						<div class="c-slider_slide-inner">
							<img src="../../uploads/projects/Second/img_galerie_1920x1080_harsha_02.jpg" alt="" />
						</div>
					</div>
					<div class="c-slider_slide || swiper-slide">
						<div class="c-slider_slide-inner">
							<img src="../../uploads/projects/Second/img_galerie_1920x1080_harsha_03.jpg" alt="" />
						</div>
					</div>
				</div>
			</div>
					...
					<div class="o-layout -gutter">
						...
						<div class="o-layout_item || c-stats_block -after3d">
							...
							<div class="o-layout -gutter">
								...
								<div class="o-layout_item u-1/2@from-medium">
									<p class="u-anim -delay-2 js-animate">With a 14 percent year-over-year increase in organic search results, our SEO efforts yielded a goal completion rate of 10 percent—meaning the site converted 10 percent more prospective patients. There was one day in particular, about two months after launch, where Second Docs received close to 300 calls—a record for the organization. Building on the success of these results, Second Docs has committed to continued engagement with eDesign, including ongoing content marketing and campaign work.</p>
								</div>
							</div>
						</div>
					</div>
					...
					<a href="home-societe.html" draggable="false" class="c-footer_lines c-heading-lines_title js-drag-zone js-hover" data-module="Footer">
						<div class="c-footer_lines_line c-heading-lines_title_line">
							<div class="o-container">
								...
								<div class="o-line -elastic">
									<canvas class="o-line_canvas js-animate" data-callback="inview.Rope()" data-module="Rope" data-delay="0.1" data-color="#fff"></canvas>
								</div>
							</div>
						</div>
...
$(document).ready(function() { 
	...
	var second_docs = document.getElementById("fir_vid");
	vid.play();
	mockup_vid.play();
	// bayswater2.play();
	second_docs.play();
