		...
		<model-viewer class="lap3dmod"
			...
			<div class="o-container || c-project_intro">
				...
				<div class="c-fancy-video c-project_intro_item js-animate has-video" data-module="FancyVideo">
					...
					<span class="c-project-header_word o-h1"  style="font-size: 5.2rem;position:absolute;bottom: -6%;">SECOND OPINION MATTERS</span>
					</div>
				</div>
...
<figure class="o-image -parallax" style="position: relative;">
	<div class="o-image_inner">
		<img src="../../uploads/projects/Second/body.jpg" alt="" class="js-animate" data-speed="-6">
	</div>
	<div style="color:#003;position: absolute;top: 70%;left: 70%;width:50%;transform: translate(-50%, -50%);">
		...
		<div class="o-section -margin-small" style="margin-top: 30px;">
            <p class="o-h4 u-no-margin js-animate u-anim -delay-1 is-show" style="width: 65%;">
...
<div class="c-device -desktop o-container" style="padding: 13.33333rem 11.2rem;margin: 0px;">
...
<div class="o-section -padding-v-huge" style="background-color: #ddd;">
	<figure class="o-container"  data-theme="light">
		<div class="c-fancy-video c-project_intro_item js-animate has-video is-show" style="padding-bottom: 5rem; !important;margin-top: 0% !important;">
			<div>
				<video id="desk_vid1" class="lazyload" autoplay loop poster="../../uploads/projects/Second/admin.png">
				</video>
				<div class="button-switch" style="position: absolute;top: 90%;left: 135%;transform: translate(-50%, -50%);width: 100%;">
						...
						<div class="button-switch" style="position: absolute;top: 85%;left: 45%;transform: translate(-50%, -50%);width: 100%;">
		...
		<p class="o-h4" style="color: #000;margin-top: 0rem;text-align: center;">Click the cross to see it in action.</p>
	</figure>
</div>
	...
	<div class="o-layout_item u-1/2@from-medium">
		<div class="c-mobile-device" style="background:#E6E6E6;">
			<div class="c-mobile-device_inner u-anim -delay-3 js-animate">
				...
				<video id="mob_1" class="lazyload" autoplay loop>
	...
	<div class="o-container demo u-bg-white" style="padding-bottom: 5rem;padding-top: 5rem;">
                    <div class="o-layout ">
                        <div class="o-layout_item u-1/2@from-small" style="position: relative;">
	                    	...
	                    	<div class="button-switch" style="position: absolute;top: 300%;left: 30%;transform: translate(-50%, 300%);">
