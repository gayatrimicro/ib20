				...
				<div class="c-project-header_block">
					...
					<div class="c-project-header_block-bottom">
						<div class="c-project-header_title -rail" data-module="Rail" data-shuffle data-rail-speed="1">
							<span class="c-project-header_word o-h1" style="font-family: Proxima-Nova-Thin-Regular;font-weight: 100;">Harsha Enterprises</span>
						</div>
					</div>
				</div>
				...
				<div class="c-project-header_block">
					...
					<div class="c-project-header_block-bottom -container">
						<div class="c-project-header_title">
							<span class="c-project-header_word o-h1">UI & Website</span>
						</div>
					</div>
				...
				<div class="o-container">
					<div class="c-project-header_cta-wrapper || js-animate" data-speed="-1" data-position="top">
						<div class="c-project-header_cta">
							<a href="https://harshaenterprises.co/" target="_blank" class="o-circle-button -large">
	...
	<div class="lap3d" style="display: none;">
		<model-viewer class="lap3dmod"
			...
			<div class="o-container || c-project_intro">
				...
				<div class="o-line -noMargin || u-none@to2-small" style="color: #003;"></div>

					<div class="o-header-block || c-project_intro_item -text -about js-animate" style="color: #003;">
						<div class="o-line -noMargin || u-none@from-small"></div>
						<h2 class="o-header-block_title u-anim -parent -delay-2">About Harsha Enterprises</h2>
						<p class="u-anim -parent -delay-4">Harsha Enterprises is a Butter Scotch Nuts & Ice cream Stabiliser blend manufacturing company. Inspirational Food Industry visionaries, they provide ethical sourcing information to their army of customers & followers.</p>
					</div>
					<div class="o-header-block || c-project_intro_item -text -work js-animate" style="color: #003;">
						<div class="o-line -noMargin || u-none@from-small"></div>
				...
				<div class="c-fancy-video c-project_intro_item js-animate -paused has-video" data-module="FancyVideo">
					...
					<div id="myid">
						<video id="fir_vid" muted poster="../../uploads/projects/Harsha/img_1920x1280_harsha-bathtub.jpg" >
...
<style type="text/css">
	.padding-manual{
		padding: 13.33333rem 11.2rem !important;margin: 0px !important;
	}
	.left-ice{
		width: 25% !important;
	}
	...
	.animation-padding{
		margin: 0px;padding: 13.33333rem 0;color: #003;
	}
	.animation-video{
		width: 120%;padding-bottom: 0px;margin-top: 3rem;	
	}
	.animation-video-inner{
		width: 120%
	}
	.grid-ice{
	...
	@media (max-width: 600px){
		.padding-manual{
			padding: 4rem 1rem !important;margin: 0px !important;
		}	
		.left-ice{
			width: 50% !important;
		}
		...
		.slider-padding{
			padding: 6.33333rem 0rem !important;background-color: #ddd
		}
		.animation-padding{
			margin: 0px;padding: 3.33333rem 0;color: #003;
		}
		.animation-video{
			width: 100%;padding-bottom: 0px;margin-top: 3rem;	
		}
		.animation-video-inner{
			width: 100%
		}
		.grid-ice{
			background-color:#ddd;padding: 0px !important;
		}
		.images-padding-b{
			padding-bottom: 0px;
		}
		...
		<div class="c-device_media">
			<div class="o-vimeo-player">
				...
				<video id="desk_vid" class="lazyload" muted="" loop>
				  <source class="lazyload" src="../../assets/videos/Harsha-Home-slow.mp4"  type="video/mp4">
				</video>
			</div>
		</div>
	</div>
...
<section>
		...
		<div class="c-fancy-video c-project_intro_item js-animate has-video is-show" style="padding-bottom: 0% !important;margin-top: 0% !important;">
			<div>
				<div class="o-layout">
                    ...
                    <div class="o-layout_item u-1/3@from-medium left-ice">
                    	<img src="../../uploads/projects/Harsha/box1.jpg">
                    </div>
                    <div class="o-layout_item u-1/3@from-medium right-ice">
	...
	<figure class="o-container"  data-theme="light">
		<div class="c-fancy-video c-project_intro_item js-animate has-video is-show" style="padding-bottom: 0% !important;margin-top: 0% !important;">
			<div>
				<video id="desk_vid1" class="lazyload" muted="" loop>
				  <source class="lazyload" src="../../assets/videos/Harsha-Product.mp4"  type="video/mp4">
				</video>
				<!-- <div class="c-fancy-video-cursor || o-cursor_wrapper || js-video-cursor js-animate" data-module="CursorZone" data-repeat data-callback="trigger.CursorZone()">
						<div class="c-fancy-video-cursor_zone || js-drag-zone"></div>
		...
		<div class="c-slider" data-module="Slider">
			<div class="c-slider_container || swiper-container || js-slider || js-drag-zone">
				<div class="c-slider_wrapper || swiper-wrapper">
					...
					<div class="c-slider_slide || swiper-slide">
						<div class="c-slider_slide-inner">
							<img src="../../uploads/projects/Harsha/img_galerie_1920x1080_harsha_03.jpg" alt="" />
						</div>
					</div>
				</div>
			</div>
  ...
  100% {
	...
	<div class="c-feature || o-layout animation-padding">
		...
		<figure class="c-feature_visual || o-layout_item u-3/5@from-medium">
			<div class="c-fancy-video c-project_intro_item js-animate has-video is-show animation-video">
				<div>
					<video id="anime_vid" class="lazyload animation-video-inner" muted="" loop>
