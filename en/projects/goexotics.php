...
<style type="text/css">
	...
	<!-- <link rel="stylesheet" type="text/css" href="../../assets/styles/calendar_page1.css">
	<link rel="stylesheet" type="text/css" href="../../assets/styles/screen.min.css.css"> -->
				...
				<div class="c-project-header_block">
					...
					<div class="c-project-header_block-bottom">
						<div class="c-project-header_title -rail" data-module="Rail" data-shuffle data-rail-speed="1">
							<span class="c-project-header_word o-h1" style="font-family: Proxima-Nova-Thin-Regular;font-weight: 100;">GoExotics</span>
						</div>
					</div>
				</div>
				...
				<div class="c-project-header_block">
					...
					<div class="c-project-header_block-bottom -container">
						<div class="c-project-header_title">
							<span class="c-project-header_word o-h1">Web App</span>
						</div>
					</div>
				...
				<div class="o-container">
					<div class="c-project-header_cta-wrapper || js-animate" data-speed="-1" data-position="top">
						<div class="c-project-header_cta">
							<a href="https://goexotics.com/" target="_blank" class="o-circle-button -large">
			...
			<div class="o-container || c-project_intro">
				...
				<div class="o-line -noMargin || u-none@to2-small"></div>
					...
					<div class="o-header-block || c-project_intro_item -text -about js-animate">
						...
						<h2 class="o-header-block_title u-anim -parent -delay-2">About GoExotics</h2>
						<p class="u-anim -parent -delay-4">Go exotics is the new five-star driving experience and the only place where you can get behind the wheel of a real racing car. All-inclusive driving experience on a track that shows its clients what it means to be a race car driver. </p>

						<p class="u-anim -parent -delay-4">Founded by a group of car enthusiasts, Go Exotics services the DMV & Dallas Fort Worth area offering thrill seekers the opportunity to drive a fleet of exotic cars. It prides itself on providing a highly professional, seamless exotic rental car experience.</p>
					</div>
				...
				<div class="c-fancy-video c-project_intro_item js-animate -paused has-video" data-module="FancyVideo">
					...
					<div id="myid">
						<video id="fir_vid" muted poster="../../uploads/projects/GoExotics/img_1920x1280_rolls-royce.jpg" >
	...
	<div class="c-device_inner u-anim -delay-3 js-animate">
		...
		<div class="c-device_media">
			<div class="o-vimeo-player">
				...
				<video id="desk_vid" class="lazyload" muted autoplay loop>
				  <source class="lazyload" src="../../assets/videos/GoExotics-Home-Flow.mp4" type="video/mp4">
				</video>
			</div>
		</div>
	</div>
	...
	<div class="c-device_inner u-anim -delay-3 js-animate">
		...
		<div class="c-device_media">
			<div class="o-vimeo-player" style="width: 93%;display: block;margin: 0 auto;border-radius: 5px;margin-top: 5px;padding-bottom: 0px;">
				...
				<video id="desk_vid" class="lazyload" autoplay loop>
				  <source class="lazyload" src="../../assets/videos/GoExotics-Product.webm"  type="video/webm">
				</video>
			</div>
		</div>
	</div>
...
<section style="background-color: #fff;padding: 10rem 2rem;">
	...
	<p class="mf-link mf-label--serif mf-label--serif--medium price" style="color: #8d004c;width: 100%;text-align: center;">
					<strong style="font-family: SackersGothicStd-Light, Helvetica, Arial, sans-serif;font-weight: 400;font-style: normal;font-size: 22px;margin: 0 auto;">Select date</strong>
				</p>
	<div id='calendar'></div>
</section>
...
<!-- <div class="o-container animate">
	<div class="c-feature || o-layout" style="margin: 0px;padding: 13.33333rem 0;">
		...
		<figure class="c-feature_visual || o-layout_item u-2/2@from-medium">
			<div class="c-fancy-video c-project_intro_item js-animate has-video is-show" style="width: 100%;padding-bottom: 0px;margin-top: 3rem;margin-right: 1rem;">
				<div>
					<img src="../../uploads/projects/GoExotics/img1.png" alt="" class="js-animate">
				</div>
			</div>
		</figure>
...
<section>
	...
	<div class="row" id="calendar-container">
			<div class="col-lg-6 calendar-top">
				<p class="mf-link mf-label--serif mf-label--serif--medium price" style="color: #8d004c;width: 100%;text-align: center;">
					<strong style="font-family: SackersGothicStd-Light, Helvetica, Arial, sans-serif;font-weight: 400;font-style: normal;font-size: 22px;margin: 0 auto;">Select date</strong>
				</p>
				<div id='calendar'>
					<center>
						<img style="top: 0; z-index: 100000;height:50px;width:50px;" id="cal_loader" src="../../assets/images/loader.gif" />
					</center>
				</div>
			</div>
	...
	<figure class="o-container"  data-theme="light">
		<div class="c-fancy-video c-project_intro_item js-animate has-video is-show" style="padding-bottom: 0% !important;margin-top: 0% !important;">
			<div>
				<video id="desk_vid1" class="lazyload" muted autoplay loop>
				  <source class="lazyload" src="../../assets/videos/GoExotics-Product.mp4" type="video/mp4">
				</video>
		...
		<div class="c-mobile-device" style="background:#E6E6E6;">
			<div class="c-mobile-device_inner u-anim -delay-3 js-animate">
				...
				<video id="mob_1" class="lazyload" autoplay loop>
				  <source class="lazyload" src="../../assets/videos/Harsha-Home-Mob.mp4"  type="video/mp4">
				</video>
			</div>
		</div>
	</div>
	<div class="o-layout_item u-1/2@from-medium">
		<div class="c-mobile-device" style="background:#0E0E0E;">
			<div class="c-mobile-device_inner u-anim -delay-5 js-animate">
				...
				<img src="../../uploads/projects/Harsha/mobile_screen_720x1280_harsha_02.jpg" alt="">
...
<div class="o-container animate">
	<div class="c-feature || o-layout" style="margin: 0px;padding: 13.33333rem 0;">
		...
		<figure class="c-feature_visual || o-layout_item u-2/2@from-medium">
			<div class="c-fancy-video c-project_intro_item js-animate has-video is-show" style="width: 100%;padding-bottom: 0px;margin-top: 3rem;margin-right: 1rem;">
				<div>
					<img src="../../uploads/projects/GoExotics/img4.jpg" alt="" class="js-animate">
				</div>
			</div>
		</figure>
...
<div class="o-container animate" style="background-color: #ddd">
	...
	<div class="c-feature || o-layout" style="margin: 0px;padding: 13.33333rem 0;">
		...
		<!-- <span class="c-project-header_word o-h2" style="font-family: Proxima-Nova-Thin-Regular;font-weight: 100;text-align: center;display: block;color: #000;"></span> -->

		<!-- <figure class="c-feature_visual || o-layout_item u-1/2@from-medium">
			<div class="c-fancy-video c-project_intro_item js-animate has-video is-show" style="width: 100%;padding-bottom: 0px;margin-top: 3rem;margin-right: 1rem;">
				<div>
					<img src="../../uploads/projects/GoExotics/Booking-Cal-Goexotics.png" alt="" class="js-animate">
				</div>
			</div>
		</figure> -->
		...
		<!-- <figure class="c-feature_visual || o-layout_item u-2/2@from-medium">
			<div class="c-fancy-video c-project_intro_item js-animate has-video is-show" style="width: 100%;padding-bottom: 0px;margin-top: 3rem;margin-left: 1rem;">
				<div>
					<img src="../../uploads/projects/GoExotics/Order-Summary-Goexotics.png" alt="" class="js-animate">
				</div>
			</div>
		</figure>
 -->
		...
		<figure class="c-feature_visual || o-layout_item u-2/2@from-medium">
			<div class="c-fancy-video c-project_intro_item js-animate has-video is-show" style="width: 100%;padding-bottom: 0px;margin-top: 3rem;border: 1px solid #0e102b;padding: 1rem;border-radius: 10px;">

				<div>
					<video id="book_vid_2" class="lazyload" muted autoplay loop style="width: 100%;border-radius: 5px;">
					  <source class="lazyload" src="../../assets/videos/GoExotics-Booking-new.mp4" type="video/mp4">
					</video>
...
<!-- <p class="o-h4" style="color: #000;margin-top: 2rem;text-align: center;">Dynamic Booking Process</p> -->
			...
			<div class="c-quote_header o-container">
				<div class="o-layout">
					...
					<div class="o-layout_item u-1/2@from-small">
						<div class="o-line -text"></div>
						<div class="o-section">
							<p class="o-h4 u-no-margin c-quote_subtitle u-2/3@from-small u-anim -delay-1 js-animate">KIRAN MAMANIA.<br>CEO, GoExotics</p>
						</div>
					</div>
				</div>
			</div>
				...
				<div class="c-slider_wrapper || swiper-wrapper">
					<div class="c-slider_slide || swiper-slide">
						<div class="c-slider_slide-inner">
							<img src="../../uploads/projects/GoExotics/img_galerie_1920x1080_goexotics_01.jpg" alt="" />
						</div>
					</div>
					<div class="c-slider_slide || swiper-slide">
						<div class="c-slider_slide-inner">
							<img src="../../uploads/projects/GoExotics/img_galerie_1920x1080_goexotics_02.jpg" alt="" />
						</div>
					</div>
					<div class="c-slider_slide || swiper-slide">
						<div class="c-slider_slide-inner">
							<img src="../../uploads/projects/GoExotics/img_galerie_1920x1080_goexotics_03.jpg" alt="" />
						</div>
					</div>
				</div>
			</div>
	...
	<div class="c-feature || o-layout" style="margin: 0px;padding: 13.33333rem 0;">
		...
		<figure class="c-feature_visual || o-layout_item u-3/5@from-medium">
			<div class="c-fancy-video c-project_intro_item js-animate has-video is-show" style="width: 120%;padding-bottom: 0px;margin-top: 3rem;">
				<div>
					<video id="anime_vid" class="lazyload" muted autoplay loop style="width: 120%;">
					  <source class="lazyload" src="../../assets/videos/GoExotics-Menu-new.mp4" type="video/mp4">
					</video>
				</div>
			</div>
		</figure>
...
$(document).ready(function() { 
	...
	// alert("Start");
	var booking1 = document.getElementById("book_vid_1");
	var booking2 = document.getElementById("book_vid_2");
