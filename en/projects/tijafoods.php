...
<head>
	...
	<link href="https://fonts.googleapis.com/css2?family=Gafata&family=Great+Vibes&family=Merriweather:ital,wght@1,300&display=swap" rel="stylesheet">
...
.c-footer {
	...
	<link rel="stylesheet" id="main-css" href="../../assets/styles/main-tija.css" media="none" onload="if(media!='all')media='all'">
...
<div class="o-scroll" data-module="Scroll" data-main-scroll>
			...
			<div class="c-project-header js-animate o_drk" data-module="ProjectHeader" data-callback="trigger.ProjectHeader()" data-repeat>
				<div class="c-project-header_block">
					...
					<div class="c-project-header_block-bottom">
						<div class="c-project-header_title -rail" data-module="Rail" data-shuffle data-rail-speed="1">
							<span class="c-project-header_word o-h1" style="font-family: Proxima-Nova-Thin-Regular;font-weight: 100;">Tija Foods</span>
						</div>
					</div>
				</div>
				...
				<div class="c-project-header_block">
					...
					<div class="c-project-header_block-bottom -container">
						<div class="c-project-header_title">
							<span class="c-project-header_word o-h1">E-commerce</span>
						</div>
					</div> 
				...
				<div class="c-project-header_block">
					<div class="o-container">
						...
						<div class="o-header-block">
							<div class="o-header-block_title u-anim -parent -delay-3" style="visibility: hidden;">Expertise</div>
						</div>
					</div>

					<div class="c-project-header_block-bottom -container">
						<div class="c-project-header_title">
							<span class="c-project-header_word o-h1">Branding</span>
						</div>
					</div> 
				...
				<div class="o-container">
					<div class="c-project-header_cta-wrapper || js-animate" data-speed="-1" data-position="top">
						<div class="c-project-header_cta">
							<a href="https://tijafoods.com/" target="_blank" class="o-circle-button -large">
								<div class="o-circle-button_bg" style="background-color: #f49c3f;"></div>
	...
	<div class="lap3d" style="display: none;">
		<model-viewer class="lap3dmod"
				  src="../../assets/images/15809_Thumbs_Up_v1.glb"
			...
			<div class="o-container || c-project_intro o_drk">
				...
				<div class="o-line -noMargin || u-none@to2-small"></div>
					...
					<div class="o-header-block || c-project_intro_item -text -about js-animate">
						...
						<h2 class="o-header-block_title u-anim -parent -delay-2">About Tija Foods</h2>
						<p class="u-anim -parent -delay-4">Tija foods is in the business of manufacturing of spices that are processed and packaged in scientific and hygienic ways. The beauty of their manufacturing lies in grinding process of the spices that involves pulverization at a subzero temperature to retain the maximum amount of essential oils in them. This ensures high quality and aroma in the readymade mixes.</p>
					</div>
					<div class="o-header-block || c-project_intro_item -text -work js-animate">
						...
						<p class="u-anim -parent -delay-5">Launching in a new market is challenging, and to help establish Tija Foods as a food ingredients player in India they needed us to adjust their messaging, refresh their signature logo icon, develop a new color system, design and build a wholesale portal, and redesign their packaging and in store marketing assets.</p>
					</div>
				...
				<div class="c-fancy-video c-project_intro_item js-animate -paused has-video" data-module="FancyVideo">
					...
					<div id="myid">
						<video id="fir_vid" muted poster="../../uploads/projects/Tija/img_1920x1280_harsha-bathtub.jpg" >
				...
				<figure class="o-image -parallax o_lig" style="background-color: #fff;">
	<div class="o-image_inner">

		<img src="../../uploads/projects/Tija/tertiary_icons.png" style="position: absolute;width: auto;height: auto;z-index: 99999999;display: block;transform: translate(40px,80px);">
		<!-- <img src="../../uploads/projects/Tija/img_1920x1260_harsha_02.jpg" alt="" class="js-animate" data-speed="-6"> -->
		<!-- <img src="../../uploads/projects/Tija/trans-mac.png" alt="" class="js-animate" data-speed="-6"> -->

		<div class="o-layout js-animate icon-gallary">
			<div class="o-layout_item u-1/2@from-medium" style="padding: 0rem;">
				<img src="../../uploads/projects/Tija/icons1.png">
			</div>
			<div class="o-layout_item u-1/2@from-medium grid-design">
				<img src="../../uploads/projects/Tija/icons6.png">
			</div>
			<!-- <div class="o-layout_item u-1/3@from-medium" style="padding: 5rem 4rem;">
				<img src="../../uploads/projects/Tija/icons5.png">
			</div> -->
			<div class="o-layout_item u-1/3@from-medium pure-icon">
				<img src="../../uploads/projects/Tija/icons3.png">
			</div>
			<div class="o-layout_item u-1/3@from-medium pure-icon">
				<img src="../../uploads/projects/Tija/icons2.png">
			</div>
			<div class="o-layout_item u-1/3@from-medium pure-icon">
				<img src="../../uploads/projects/Tija/icons4.png">
			</div>
		</div>
	</div>
</figure>
...
<div class="c-device -desktop o-container outline-laptop o_drk">
	<div class="c-device_inner u-anim -delay-3 js-animate">
		<img src="../../assets/images/laptop.png" alt="">
		<div class="c-device_media">
			<div class="o-vimeo-player" style="width: 92%;display: block;margin: 0 auto;border-radius: 5px;margin-top: 5px;padding-bottom: 0px;">
				...
				<video id="desk_vid" class="lazyload" muted="" loop>
				  <source class="lazyload" src="../../assets/videos/Tija-Home.mp4"  type="video/mp4">
				</video>
			</div>
		</div>
	</div>
...
<section style="background-color: #e47a33;">

<figure class="o-image -parallax o_drk" style="background-color: #f0a82e;width: 80%;">
	<div class="o-image_inner ">

		<img src="../../uploads/projects/Tija/logonew.png" class="logo-floating">
		<div class="o-layout js-animate font-used">
				<div class="o-layout_item u-1/3@from-medium" style="padding: 5rem 4rem;">
					<h3 style="margin-bottom: 0px;font-family: 'Merriweather', serif;font-weight: 300;	">Merriweather</h3>
					<div class="o-line -text" style="margin-top: 10px;margin-bottom: 10px;"></div>
					<p style="font-size: 20px;">Heading Text</p>
					<p>300 Font Weight</p>
				</div>
				<div class="o-layout_item u-1/3@from-medium" style="padding: 5rem 4rem;">
					<h3 style="margin-bottom: 0px;font-family: 'Great Vibes', cursive;">Great Vibes</h3>
					<div class="o-line -text" style="margin-top: 10px;margin-bottom: 10px;"></div>
					<p style="font-size: 20px;">Sub-Heading Text</p>
					<p>100 Font Weight</p>
				</div>
				<div class="o-layout_item u-1/3@from-medium" style="padding: 5rem 4rem;">
					<h3 style="margin-bottom: 0px;font-family: 'Gafata', sans-serif;font-weight: 700;">Gafata</h3>
					<div class="o-line -text" style="margin-top: 10px;margin-bottom: 10px;"></div>
					<p style="font-size: 20px;">Pricing Text</p>
					<p>700 Font Weight</p>
				</div>
...
<style type="text/css">
	.prod-desc{
		color: black;position: absolute;display: block;z-index: 999999999;top: 60%;left: -20%;width: 50%;
	}
	.prod-heading{
		margin-bottom: 0px;font-family: 'Merriweather', serif;font-weight: 300;margin-top: 2rem;
	}
	.prod-count{
		font-family:'Great Vibes', sans-serif;font-size: 5rem;opacity: 0.6;
	}
	.prod-sub-heading{
		margin-bottom: 0px;font-family: 'Merriweather', serif;font-weight: 300;margin-top: 0.5rem;font-size: 1.3rem;
	}
	.icon-gallary{
		padding: 15rem 10rem;
	}
	...
	.outline-laptop{
		padding: 13.33333rem 11.2rem;margin: 0px;position: relative;background-color: #ea5159;
	}
	.font-used{
		padding: 15rem 5rem;
	}
	.bag-pattrn{
		padding: 11.33333rem 0rem;background: linear-gradient(to bottom, #fff 70%, #fff 30%);width: 80%;height:150vh;position: relative;
	}
	.logo-floating{
		position: absolute;width: 200px !important;height: 200px;z-index: 99999999;display: block;transform: translate(40px,52rem);right: 25%;
	}
	@media (max-width: 600px){
		.prod-count{
			font-size: 4rem;
		}
		.product-slider .c-slider_slide {
		    padding: 70px .33333rem;
		}
		.icon-gallary{
			padding: 15rem 0rem 2rem 0rem;
		}
		.grid-design{
		...
		.logo-floating{
			position: absolute;width: 200px !important;height: 200px;z-index: 99999999;display: block;transform: translate(40px,55rem);right: 40%;
		}
		.padding-box{
			padding-top: 16rem;
		}
		...
		.prod-desc{
			color: black;position: absolute;display: block;z-index: 999999999;top: 60%;left: 0%;width: 50%;
		}
		.slider-mob img{
			max-width: 130%;
			width: 130%;
	...
	@media (min-width: 1025px){
		...
		.packing .c-slider_slide-inner img {
		    transform: scale(1.25);
		    transition: none;
		}
		.pattrn-side{
			position: absolute;top: 0;left: 0;width: 100%;opacity: 0.05;
		}
}
...
@media (min-width: 1400px){
		...
		<div class="o-section -padding-v-big packing bag-pattrn o_lig">
			<img src="../../uploads/projects/Tija/side-pattern.png" class="pattrn-side desk-vis">
	<div class="o-cursor_wrapper u-relative -show-native o-container js-animate padding-box" data-module="CursorZone" data-repeat data-callback="trigger.CursorZone()" data-draggable="true">
		<!-- <div class="o-cursor -alpha js-cursor -ahead -drag -points -h">
			<div class="o-cursor_background"></div>
		</div> -->
		

		<h2 style="margin-bottom: 0px;font-family: 'Merriweather', serif;font-weight: 900;font-size: 5rem;color: #e47a33;">Freshly ground to order</h2>
		<div class="o-cursor -white || js-cursor">
						<div class="o-cursor_background" style="background-color: #ebe9e5"></div>
						<div class="o-cursor_label">
							<div class="o-cursor_label_outer">
								<div class="o-cursor_label_inner">
									<span>Swipe</span>
					...
					<div style="position: absolute;display: block;top: 56%;right: 11%;opacity: 0.6;" class="desk-vis">
						<img src="../../assets/images/right-arrow.png" style="width: 100px;height: 100px" alt="" />	
					</div>
					<div style="position: absolute;display: block;top: 56%;left: 37%;opacity: 0.6;" class="desk-vis">
						<img src="../../assets/images/left-arrow.png" style="width: 100px;height: 100px" alt="" />	
					</div>
		<div class="c-slider product-slider" data-module="Slider">
			<div class="c-slider_container || swiper-container || js-slider || js-drag-zone">
				<div class="c-slider_wrapper || swiper-wrapper">
					<div class="c-slider_slide || swiper-slide">
						<div class="c-slider_slide-inner slider-mob">
							<img src="../../uploads/projects/Tija/Slider1.png" alt="" />
							<div class="prod-desc">
								<span class="c-project-header_word o-h1 prod-count">1/6</span>
								<!-- <h3 class="prod-heading">Assam Masala Chai</h3> -->
								<h4 class="prod-sub-heading" >Lorem Ipsum is simply dummy text of the printing and typesetting industry.</h4>
							</div>
						</div>
					</div>
					<div class="c-slider_slide || swiper-slide">
						<div class="c-slider_slide-inner slider-mob">
							<img src="../../uploads/projects/Tija/Slider2.png" alt="" />
							<div class="prod-desc">
								<span class="c-project-header_word o-h1 prod-count">2/6</span>
								<!-- <h3 class="prod-heading">Hyderabadi Biryani</h3> -->
								<h4 class="prod-sub-heading" >Lorem Ipsum is simply dummy text of the printing and typesetting industry.</h4>
							</div>
						</div>
					</div>
					<div class="c-slider_slide || swiper-slide">
						<div class="c-slider_slide-inner slider-mob">
							<img src="../../uploads/projects/Tija/Slider3.png" alt="" />
							<div class="prod-desc">
								<span class="c-project-header_word o-h1 prod-count">3/6</span>
								<!-- <h3 class="prod-heading">Bombay Sandwich</h3> -->
								<h4 class="prod-sub-heading" >Lorem Ipsum is simply dummy text of the printing and typesetting industry.</h4>
							</div>
						</div>
					</div>
					<div class="c-slider_slide || swiper-slide">
						<div class="c-slider_slide-inner slider-mob">
							<img src="../../uploads/projects/Tija/Slider4.png" alt="" />
							<div class="prod-desc">
								<span class="c-project-header_word o-h1 prod-count">4/6</span>
								<!-- <h3 class="prod-heading">Bengal Gram Flour</h3> -->
								<h4 class="prod-sub-heading" >Lorem Ipsum is simply dummy text of the printing and typesetting industry.</h4>
							</div>
						</div>
					</div>
					<div class="c-slider_slide || swiper-slide">
						<div class="c-slider_slide-inner slider-mob">
							<img src="../../uploads/projects/Tija/Slider5.png" alt="" />
							<div class="prod-desc">
								<span class="c-project-header_word o-h1 prod-count">5/6</span>
								<!-- <h3 class="prod-heading">Turmeric Powder</h3> -->
								<h4 class="prod-sub-heading" >Lorem Ipsum is simply dummy text of the printing and typesetting industry.</h4>
							</div>
						</div>
					</div>
					<div class="c-slider_slide || swiper-slide">
						<div class="c-slider_slide-inner slider-mob">
							<img src="../../uploads/projects/Tija/Slider6.png" alt="" />
							<div class="prod-desc">
								<span class="c-project-header_word o-h1 prod-count">6/6</span>
								<!-- <h3 class="prod-heading">Veg. Kadai Masala</h3> -->
								<h4 class="prod-sub-heading" >Lorem Ipsum is simply dummy text of the printing and typesetting industry.</h4>
							</div>
						</div>
					</div>
...
<!-- <figure class="o-image -parallax">
	<div class="o-image_inner">
		<img src="../../uploads/projects/Tija/herbs.jpg" alt="" class="js-animate" data-speed="-6">
	</div>
</figure> -->

<section>
	<div class="o-layout js-animate o_drk">
	<div class="o-layout_item u-1/2@from-medium">
		<div class="" style="height:35rem;background:#e47a33;position: relative;">
			<div class=" u-anim -delay-3 js-animate" style="padding: 3rem">
				<h3 style="margin-bottom: 0px;">Dark orange</h3>
				<div class="o-line -text" style="margin-top: 25px;margin-bottom: 25px;"></div>
				<p>PRIMARY</p>

				<p style="position: absolute;bottom: 20%;">Hex #e47a33</p>
			</div>
		</div>
	</div>
	<div class="o-layout_item u-1/2@from-medium">
		<div class="" style="height:35rem;background:#f0a82e;position: relative;">
			<div class=" u-anim -delay-5 js-animate">
				<div class=" u-anim -delay-3 js-animate" style="padding: 3rem">
				<h3 style="margin-bottom: 0px;">Mango Orange</h3>
				<div class="o-line -text" style="margin-top: 25px;margin-bottom: 25px;"></div>
				<p>PRIMARY</p>

				<p style="position: absolute;bottom: 20%;">Hex #f0a82e</p>
			</div>
...
<div class="o-layout js-animate o_lig">
	<div class="o-layout_item u-1/3@from-medium">
		<div class="" style="height:35rem;background:#ebe9e5;position: relative;">
			<div class=" u-anim -delay-3 js-animate">
				<div class=" u-anim -delay-5 js-animate">
				<div class=" u-anim -delay-3 js-animate" style="padding: 3rem;color: #000 !important;">
				<h3 style="margin-bottom: 0px;">Shiny Silver</h3>
				<div class="o-line -text" style="margin-top: 25px;margin-bottom: 25px;"></div>
				<p>SECONDARY</p>

				<p style="position: absolute;bottom: 20%;">Hex #ebe9e5</p>
			</div>
	...
	<div class="o-layout_item u-1/3@from-medium">
		<div class="" style="height:35rem;background:#b1805a;position: relative;">
			<div class=" u-anim -delay-3 js-animate">
				<div class=" u-anim -delay-5 js-animate">
				<div class=" u-anim -delay-3 js-animate" style="padding: 3rem;color: #000 !important;">
				<h3 style="margin-bottom: 0px;">Milky Brown</h3>
				<div class="o-line -text" style="margin-top: 25px;margin-bottom: 25px;"></div>
				<p>SECONDARY</p>

				<p style="position: absolute;bottom: 20%;">Hex #b1805a</p>
			</div>
	...
	<div class="o-layout_item u-1/3@from-medium">
		<div class="" style="height:35rem;background:#101820;position: relative;">
			<div class=" u-anim -delay-5 js-animate">
				<div class=" u-anim -delay-5 js-animate">
				<div class=" u-anim -delay-3 js-animate" style="padding: 3rem;color: #fff !important;">
				<h3 style="margin-bottom: 0px;">Magestic Blue</h3>
				<div class="o-line -text" style="margin-top: 25px;margin-bottom: 25px;"></div>
				<p>SECONDARY</p>

				<p style="position: absolute;bottom: 20%;">Hex #101820</p>
			</div>
	...
	<div class="o-layout_item u-1/2@from-medium">
		<div class="c-mobile-device" style="background:#E6E6E6;">
			<div class="c-mobile-device_inner u-anim -delay-3 js-animate">
				...
				<img src="../../uploads/projects/Tija/bombay-sandwich-masala.png" alt="">
	...
	<div class="o-layout_item u-1/2@from-medium">
		<div class="c-mobile-device" style="background:#0E0E0E;">
			<div class="c-mobile-device_inner u-anim -delay-5 js-animate">
				<img src="../../uploads/projects/Tija/hyderabadi-biryani-masala.png" alt="">
...
<style type="text/css">
	.classic-vectors{
		width: 30%;height: 80rem;
	}
	.inner-vector-padding{
		padding: 30rem 3rem;color: #101820
	}
	.box-content-tija{
		width: 70%;height: 80rem;
	}
	.tija-content{
		 padding: 30rem 25rem 16rem 6rem;
	}
	.outline-mobile {
	    padding: 4rem;
	    margin-top: 3rem;
	...
	.outline-mob{
		width: 80% !important;
	    top: 0% !important;
	    transform: translate(-22px, -62px) !important;
	}
	.outline-mob-video{
	    width: 68% !important;
	    border: thin solid #ea5159;
	}
	.mob-vid-content{
		 margin-top: 3rem;
	}
	.slider-boxes{
		    padding: 13.33333rem 0rem;
	...
	@media (max-width: 600px){
		...
		.inner-vector-padding{
			padding: 4rem 2rem;color: #101820
		}
		.box-content-tija{
...
<section>
	...
	<div class="o-layout js-animate o_lig" style="position: relative;">
		<div class="o-layout_item u-1/2@from-medium classic-vectors">
			<div  style="background:#fff; height: 100%;"><!-- background:#101820 -->
				<div class="u-anim -delay-3 js-animate inner-vector-padding">
					<h4>Silky Pink</h4>
				<div class="o-line -text" style="margin-top: 15px;margin-bottom: 15px;color: #101820"></div>
					<p>hex #f9e6e1</p>
					<div class="c-project-header_cta-wrapper || js-animate" data-speed="-1" data-position="right">
					<img src="../../uploads/projects/Tija/4.png" style="padding: 6rem 2rem;">
				</div>
				</div>
			</div>
		</div>
		<div class="o-layout_item u-1/2@from-medium box-content-tija">
			<div style="background-image: url(../../uploads/projects/Tija/bg-change.jpg); height: 100%;background-position: center;background-size: cover;">
				<div class="u-anim -delay-5 js-animate tija-content">
					<p style="font-size: 20px;margin-top: 20px;">A sign of perfection and care, and our personal stamp of excellence, the rosetta is the signature of Campos’ true specialty coffee.</p><br><br>
					<p style="font-size: 20px;margin-top: 20px;">Every Campos barista is specially trained to master the rosetta and create it with focus and precision. Every. Single. Time.</p><br><br>
					<p style="font-size: 20px;margin-top: 20px;">The rosetta is so much more than our logo. It is the final touch of what was a 30-step, hand-crafted process from crop to cup.</p>
				</div>
			</div>
		</div>
		<h2 style="position: absolute;top: 50%;left: 20%;font-weight: 900;font-size: 5rem;"><span style="color:#101820; ">Tija</span> Foods</h2>
	</div>
...
<section>
	<div class="o-container demo u-bg-white o_lig" style="padding-bottom: 5rem;padding-top: 5rem;position: relative;margin-top: -3px;">
                        ...
                        <div class="o-layout_item u-1/2@from-small">
                        	<!-- <div class="o-section -padding-top -margin-small">
                                <div class="u-2/3@from-big">
                                    <p class="js-animate u-anim -delay-1 o-h3">Sample text here.</p>
                                    
                                </div>
                            </div> -->
                            <div class="c-mobile-device outline-mobile">
								<div class="c-mobile-device_inner u-anim -delay-3 js-animate" style="padding: 0px;">
									<img class="outline-mob" src="../../assets/images/iphone.svg">
									<!-- <img src="../../uploads/projects/Harsha/mobile_screen_720x1280_harsha_01.jpg" alt=""> -->
									<video id="mob_1" class="outline-mob-video" class="lazyload" muted="" loop>
									  <source class="lazyload" src="../../assets/videos/Mob-Tija.mp4"  type="video/mp4">
									</video>
								</div>
							</div>													
                        </div>
                        <div class="o-layout_item u-1/2@from-small mob-vid-content">
                            <div class="o-section -padding-top -margin-small">
                                <div class="u-2/3@from-big">
                                    <p class="js-animate u-anim -delay-1">In our research, we identified two major customer groups, adopters and experts. It was important to create a compelling and accessible experience for this range of specialty stabiliser blends.More than just beautiful imagery, product pages include the key details food experts of their industry need to know, along with helpful definitions for those looking to increase their knowledge.</p>
                            ...
                            <div class="o-section -margin-small">
                                <p class="o-h4 u-no-margin u-2/3@from-small js-animate u-anim -delay-1 is-show">Of course, the site had to work flawlessly across all devices and screen sizes. Finally, ordering had to be simple and using the site had to be enjoy.</p>
                                	<!-- <div class="" style="margin-top: 30px;">
                                        <a onclick="window.location.href='#'" class="o-circle-button -large c-home_about_cta" style="width: 8rem;height: 8rem;">
		...
		<div class="c-fancy-video c-project_intro_item js-animate -paused has-video is-show" style="padding-bottom: 0% !important;margin-top: 0% !important;">
			<div>
				<video id="normal_vid" class="lazyload" autoplay loop>
				  <source class="lazyload" src="../../assets/videos/Harsha-Overview.mp4"  type="video/mp4">
				</video>
			...
			<div class="c-quote_header o-container">
				<div class="o-layout">
					...
					<div class="o-layout_item u-1/2@from-small">
						<div class="o-line -text"></div>
						<div class="o-section">
							<p class="o-h4 u-no-margin c-quote_subtitle u-2/3@from-small u-anim -delay-1 js-animate">KIRAN MAMANIA.<br>CEO, HARSHA ENTERPRISES</p>
						</div>
					</div>
				</div>
			</div>
...
<style type="text/css">
	.small-slider .c-slider_slide-inner img {
		    transform: scale(1);
		    transition: none;
		}
</style>

		<div class="o-section -padding-v-big small-slider slider-boxes o_lig">
				...
				<div class="c-slider_wrapper || swiper-wrapper">
					<div class="c-slider_slide || swiper-slide">
						<div class="c-slider_slide-inner">
							<img src="../../uploads/projects/Tija/pre-Slider2.jpg" alt="" />
							<!-- <video id="slider_1" class="lazyload" autoplay loop style="width: 100%">
							  <source class="lazyload" src="../../assets/videos/Tija-Home-Cart.mp4"  type="video/mp4">
							</video> -->
						</div>
					</div>
					<div class="c-slider_slide || swiper-slide">
						<div class="c-slider_slide-inner">
							<img src="../../uploads/projects/Tija/pre-Slider3.jpg" alt="" />
							<!-- <video id="slider_1" class="lazyload" autoplay loop style="width: 100%">
							  <source class="lazyload" src="../../assets/videos/Tija-Home-Cart.mp4"  type="video/mp4">
							</video> -->
						</div>
					...
					<div class="c-slider_slide || swiper-slide">
						<div class="c-slider_slide-inner">
							<img src="../../uploads/projects/Tija/pre-Slider4.jpg" alt="" />
							<!-- <video id="slider_1" class="lazyload" autoplay loop style="width: 100%">
							  <source class="lazyload" src="../../assets/videos/Tija-Home-Cart.mp4"  type="video/mp4">
							</video> -->
						</div>
					...
					<div class="c-slider_slide || swiper-slide">
						<div class="c-slider_slide-inner">
							<img src="../../uploads/projects/Tija/pre-Slider1.jpg" alt="" />
							<!-- <video id="slider_1" class="lazyload" autoplay loop style="width: 100%">
							  <source class="lazyload" src="../../assets/videos/Tija-Home-Cart.mp4"  type="video/mp4">
							</video> -->
						</div>
...
@keyframes openclose {
  ...
  100% {
	...
	<div class="c-feature || o-layout" style="margin: 0px;padding: 13.33333rem 0;">
		<div class="c-feature_content || o-layout_item u-2/5@from-medium">
			...
			<h1>
			  <span>animated</span>
			  <div class="message">
			    <div class="word1">Effects</div>
			    <div class="word2">Effects</div>
			    <div class="word3">Effects</div>
			  </div>
			</h1>
		...
		<figure class="c-feature_visual || o-layout_item u-3/5@from-medium">
			<div class="o-vimeo-player">
				...
				<div class="o-section -padding-v-huge o_lig" style="background-color:#fff;margin-top: -3px;">
	<figure class="o-container">
		<div class="o-vimeo-player js-animate u-anim -delay-1">
			<img src="../../uploads/projects/Tija/img_1920x1260_harsha_ice_01.jpg" alt="" class="js-animate" data-speed="-6">
		</div>
	</figure>
</div>
					...
					<div class="o-layout -gutter">
						...
						<div class="o-layout_item || c-stats_block -after3d">
							...
							<div class="o-layout -gutter">
								...
								<div class="o-layout_item u-1/2@from-medium">
									<p class="u-anim -delay-2 js-animate">We created a complete brand identity for the ice cream stabiliser Market, a holding page which helped gain initial traction and helped him build the brand recognition. The landing page was designed to romanticise the concept, making people feel the same way we did when we first learnt about the problem. Using friendly, short copy paired with bright imagery, we gave the user a narrative, urging them to easily connect and order.</p>
								</div>
							</div>
						</div>
					</div>
    ...
    pointer-events: none;
    display: block;
    background: -webkit-gradient(linear,left bottom,left top,from(#001646),to(rgba(0,22,70,0)));
