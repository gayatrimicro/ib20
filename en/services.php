...
<head>
    ...
    <link rel="stylesheet" id="main-css" href="../assets/styles/main-services.css" media="none" onload="if(media!='all')media='all'">
...
<div class="o-scroll" data-module="Scroll" data-main-scroll>
    <main class="o-page">
        <div class="u-relative">
            <div class="u-z-index-100 || u-bg-black">
            ...
            <figure class="o-image">
                <div class="o-image_inner">
                    <img src="../uploads/projects/General/smoke-mix.jpg" alt="" class="js-animate">
                </div>
            </figure>
            <!-- <div class="c-video-player -parallax" data-module="VideoPlayer" data-play="Play" data-pause="Pause">
                <div class="c-video-player_preview || o-vimeo-player || js-animate" data-speed="-6">
                    <iframe class="js-animate" data-repeat data-callback="launch.VimeoPlayer()" data-module="VimeoPlayer" src="https://player.vimeo.com/video/340041068?controls=false&autoplay=0&transparent=false&autopause=false&loop=1&muted=1" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen allow="autoplay; encrypted-media"></iframe>
                </div>

                <div class="c-video-player_video || o-vimeo-player">
                    <iframe class="js-video" src="https://player.vimeo.com/video/339578063?controls=false&autoplay=0&loop=0&transparent=false&autopause=false&muted=0&playsinline=false" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen allow="autoplay; encrypted-media"></iframe>
                </div>

                <div class="c-video-player_cursor || o-cursor_wrapper || js-video-cursor js-animate" data-repeat data-callback="trigger.CursorZone()" data-module="CursorZone">
                    <div class="c-video-player_cursor-zone || js-drag-zone"></div>
            ...
            <div class="u-bg-white u-relative">
                ...
                <div class="o-container">
                    <div class="o-section -padding-top -margin-small">
                        <span class="o-h -indent -top"></span> <p class="o-h2 -inline-block || o-fade-up-rows || js-animate" data-module="FadeUpByRow" data-lines-class="o-fade-up-rows_line" data-viewport-offset="0.15">Made in Montreal,<br><span class="u-italic">Quebec, Canada</span></p>
                    </div>

                    <div class="o-section js-animate">
                        <div class="o-section_heading">
                            <h1 class="o-section_heading_title o-h -indent u-anim -parent -delay-2">About</h1> <p class="o-section_heading_content o-h2 o-fade-up-rows -text-indent || js-animate" data-module="FadeUpByRow" data-lines-class="o-fade-up-rows_line" data-viewport-offset="0.15"><span class="o-fade-up-rows_indent-el"></span>iBridge stands out among web agencies, and offers a wide range of creative and strategic services for brands, companies, foundations and other remarkable organizations. We assist and educate our clients in making the best use of the solutions we build with them.</p>
                        </div>
                    </div>
                    ...
                    <section class="o-section -margin-small">
                        ...
                        <div class="o-layout -gutter-huge js-animate ">
                            <div class="o-layout_item u-2/6@from-small">
                                <h2 class="o-h -normal -margin-small u-anim -delay-2 -parent">Established in 2007</h2>
                            </div>
                            <div class="o-layout_item u-1/6@from-small"></div>
                            <div class="o-layout_item u-3/6@from-small">
                                <div class="u-2/3@from-small">
                                    <p class="u-anim -delay-4 -parent">In a few short years, iBridge has made its mark on Montreal — our home and a powerhouse recognized internationally for its creativity. With a unique identity rooted in Quebec, its reputation branches far beyond its borders.</p>
                                </div>
                            </div>
                        </div>
                    </section>
